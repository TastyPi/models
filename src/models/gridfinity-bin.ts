...
export const GRIDFINITY_BIN_SETTINGS: Record<string, string> = { fill_density: '5%', fill_pattern: 'rectilinear', brim_type: 'outer_only', brim_width: '5', brim_separation: '0.45' }
